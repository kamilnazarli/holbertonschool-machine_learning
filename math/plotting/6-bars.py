...
def bars():
    ...
    plt.bar(categories, oranges, bottom=apples+bananas, color='#ff8000', width=0.5)
    plt.bar(categories, peaches, bottom=apples+bananas+oranges, color='#ffe5b4', width=0.5)
